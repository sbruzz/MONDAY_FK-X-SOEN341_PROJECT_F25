...
1. Discussion of potential user story suggestion: Send email to students/organizers when events are soon
2. What to focus on
3. Role discussion
4. CSV clarification (SQL for database)
5. Discussion of potential user story suggestion: See other students going to same event
6. Discussion of potential user story suggestion: Organizer preview to judge interest
7. Postman for testing
8. Workflow discussion
9. Pull request reviewers discussion
10. Whoops issues completed by not assignee (Task.32 and Task.30)

### 2. Sprint 1 Retrospective Summary
- **What went well:**
