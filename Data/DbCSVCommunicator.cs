    ...
    public void Test()
    {
        ...
        if (!_context.Events.Any(e => e.Id >= 801 && e.Id <= 806))
        {
            ...
            _context.Events.AddRange(
                ...
                new Event { Id = 804, Title = "Hackathon 2025", Description = "24-hour coding competition", Category = "Other", EventDate = DateTime.UtcNow.AddDays(21), Location = "H-Building", Capacity = 80, TicketType = TicketType.Free, Price = 0, OrganizerId = organizer1Id, OrganizationId = org1Id, ApprovalStatus = ApprovalStatus.Approved, CreatedAt = DateTime.UtcNow.AddDays(-10) },
