    ...
    public void Test()
    {
        ...
        if (!_context.Users.Any(u => u.Id >= 551 && u.Id <= 565))
        {
            ...
            _context.Users.AddRange(
                new User { Id = 551, Email = "alice.smith@student.concordia.ca", PasswordHash = hashedPassword, Name = "Alice Smith", Role = UserRole.Student, ApprovalStatus = ApprovalStatus.Approved, StudentId = "40101001", Program = "Computer Science", YearOfStudy = "3rd Year", PhoneNumber = "5141234567", CreatedAt = DateTime.UtcNow.AddDays(-30) },
                new User { Id = 552, Email = "bob.johnson@student.concordia.ca", PasswordHash = hashedPassword, Name = "Bob Johnson", Role = UserRole.Student, ApprovalStatus = ApprovalStatus.Approved, StudentId = "40101002", Program = "Engineering", YearOfStudy = "2nd Year", PhoneNumber = "5141234568", CreatedAt = DateTime.UtcNow.AddDays(-25) },
                new User { Id = 553, Email = "carol.williams@student.concordia.ca", PasswordHash = hashedPassword, Name = "Carol Williams", Role = UserRole.Student, ApprovalStatus = ApprovalStatus.Approved, StudentId = "40101003", Program = "Business", YearOfStudy = "4th Year", PhoneNumber = "5141234569", CreatedAt = DateTime.UtcNow.AddDays(-20) },
                new User { Id = 554, Email = "david.brown@student.concordia.ca", PasswordHash = hashedPassword, Name = "David Brown", Role = UserRole.Student, ApprovalStatus = ApprovalStatus.Approved, StudentId = "40101004", Program = "Computer Science", YearOfStudy = "1st Year", PhoneNumber = "5141234570", CreatedAt = DateTime.UtcNow.AddDays(-15) },
                new User { Id = 555, Email = "eve.davis@student.concordia.ca", PasswordHash = hashedPassword, Name = "Eve Davis", Role = UserRole.Student, ApprovalStatus = ApprovalStatus.Approved, StudentId = "40101005", Program = "Arts", YearOfStudy = "2nd Year", PhoneNumber = "5141234571", CreatedAt = DateTime.UtcNow.AddDays(-10) }
            );

            // Add organizers
            _context.Users.AddRange(
                new User { Id = 561, Email = "tech.club@concordia.ca", PasswordHash = hashedPassword, Name = "Sarah Martinez", Role = UserRole.Organizer, ApprovalStatus = ApprovalStatus.Approved, Position = "President", Department = "Computer Science", PhoneNumber = "5149876543", CreatedAt = DateTime.UtcNow.AddDays(-60) },
                new User { Id = 562, Email = "music.society@concordia.ca", PasswordHash = hashedPassword, Name = "Mike Chen", Role = UserRole.Organizer, ApprovalStatus = ApprovalStatus.Approved, Position = "Coordinator", Department = "Fine Arts", PhoneNumber = "5149876544", CreatedAt = DateTime.UtcNow.AddDays(-55) },
                new User { Id = 563, Email = "sports.association@concordia.ca", PasswordHash = hashedPassword, Name = "Jennifer Lee", Role = UserRole.Organizer, ApprovalStatus = ApprovalStatus.Approved, Position = "Director", Department = "Athletics", PhoneNumber = "5149876545", CreatedAt = DateTime.UtcNow.AddDays(-50) }
            );

            // Add pending organizers (to show approval workflow)
            _context.Users.AddRange(
                new User { Id = 564, Email = "new.club@concordia.ca", PasswordHash = hashedPassword, Name = "Tom Wilson", Role = UserRole.Organizer, ApprovalStatus = ApprovalStatus.Pending, Position = "Founder", Department = "Business", PhoneNumber = "5149876546", CreatedAt = DateTime.UtcNow.AddDays(-2) },
                new User { Id = 565, Email = "pending.org@concordia.ca", PasswordHash = hashedPassword, Name = "Lisa Garcia", Role = UserRole.Organizer, ApprovalStatus = ApprovalStatus.Pending, Position = "President", Department = "Engineering", PhoneNumber = "5149876547", CreatedAt = DateTime.UtcNow.AddDays(-1) }
            );
